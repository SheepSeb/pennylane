...
class TestValidation:
    ...
    def test_best_method_is_backprop(self, monkeypatch):
        ...
        dev = qml.device("default.qubit.legacy", wires=1)
        monkeypatch.setitem(dev.target_device._capabilities, "passthru_interface", "some_interface")
        monkeypatch.setitem(dev.target_device._capabilities, "provides_jacobian", False)
    ...
    def test_adjoint_finite_shots(self):
        """Tests that a QuantumFunctionError is raised with the adjoint differentiation method
